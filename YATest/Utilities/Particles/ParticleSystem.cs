...
namespace ParticleClassLibrary
{
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        /// </summary>
        protected abstract void InitializeSettingsForDark(ParticleSettings settings);
        ...
        {
            Effect effect = content.Load<Effect>("ParticleEffect").Clone(Game.GraphicsDevice);
